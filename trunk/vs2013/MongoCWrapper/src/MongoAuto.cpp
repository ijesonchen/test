...
namespace MongoClib
{
	...
	ArrayParser::~ArrayParser() { ClearResultBson(); };
	...
	const bson_t* ArrayParser::Bson() const { return m_p; }
	...
	const char* AutoPoolColl::Error(void) const 
	{ 
...
#pragma warning(pop)
	...
	inline bool BsonParser<BsonT>::GetCntr(const std::string& key, Container& cntr, TransFunc transFunc) const
	{
